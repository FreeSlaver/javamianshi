...
layout: page
breadcrumb: true
title: Java JVM面试题 带答案
category: jvm
categoryStr: JVM面试题
tags: [jvm java 面试题]
keywords: [jvm java 面试题]
description: JVM面试题大全,JVM面试题大全
---
...
Java内存结构？
image_1bl9t6q6lab0okofov1umv7ct13.png-70.2kB
...
类加载器
image_1bl9t477ei1r1e0k193mpu61q2im.png-24kB
...
类的生命周期
类的生命周期包括这几个部分，加载、连接、初始化、使用和卸载，其中前三部是类的加载的过程,如下图； image_1bl9t1geg15lj58p41kd151k699.png-41.6kB
